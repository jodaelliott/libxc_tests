...
!   REAL(8) :: exc(5)
   ...
   REAL(8), DIMENSION(262144) :: rho, rho_core, exc, sigma
   REAL(8) :: Etxc
   ...
   ! Read valence and core densities
   ...
   CALL xc_f90_func_init(xc_func, func_x_id, XC_UNPOLARIZED)
   !CALL xc_f90_func_init(xc_func, func_c_id, XC_UNPOLARIZED)
